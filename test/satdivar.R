...
main_directory <- "/Volumes/My Passport for Mac/01_PhD_PostDoc_Göttingen_Jena_Ilmenau/articles_ideas/github_rarefaction-like_analysis_genetic_diversity_Karbstein_et_al/GD_satur_Karbstein_et_al_und_rev/example/results/"
...
directory <- "/Volumes/My Passport for Mac/01_PhD_PostDoc_Göttingen_Jena_Ilmenau/articles_ideas/github_rarefaction-like_analysis_genetic_diversity_Karbstein_et_al/GD_satur_Karbstein_et_al_und_rev/example/results/functional_trait_diversity/"
...
for(i in sprintf("%02d", 1:20)) {
  mymergeddata_i <- multmerge(paste("/Volumes/My Passport for Mac/01_PhD_PostDoc_Göttingen_Jena_Ilmenau/articles_ideas/github_rarefaction-like_analysis_genetic_diversity_Karbstein_et_al/GD_satur_Karbstein_et_al_und_rev/example/results/functional_trait_diversity/", i, sep = ""))
...
results = multmerge("/Volumes/My Passport for Mac/01_PhD_PostDoc_Göttingen_Jena_Ilmenau/articles_ideas/github_rarefaction-like_analysis_genetic_diversity_Karbstein_et_al/GD_satur_Karbstein_et_al_und_rev/example/results/functional_trait_diversity/results/")
...
### iFDCV ~ Number of Replicates (across all 13 populations)
...
directory <- "/Volumes/My Passport for Mac/01_PhD_PostDoc_Göttingen_Jena_Ilmenau/articles_ideas/github_rarefaction-like_analysis_genetic_diversity_Karbstein_et_al/GD_satur_Karbstein_et_al_und_rev/example/results/genetic_diversity/"
...
# iterate over data
for (file in files) {
  # Extrahieren des Basisdateinamens
  file_name <- basename(file)
...
for(i in sprintf("%02d", 1:18)) {
  mymergeddata_i <- multmerge(paste("/Volumes/My Passport for Mac/01_PhD_PostDoc_Göttingen_Jena_Ilmenau/articles_ideas/github_rarefaction-like_analysis_genetic_diversity_Karbstein_et_al/GD_satur_Karbstein_et_al_und_rev/example/results/genetic_diversity/", i, sep = ""))
...
results = multmerge("/Volumes/My Passport for Mac/01_PhD_PostDoc_Göttingen_Jena_Ilmenau/articles_ideas/github_rarefaction-like_analysis_genetic_diversity_Karbstein_et_al/GD_satur_Karbstein_et_al_und_rev/example/results/genetic_diversity/results/")
...
### GD ~ Number of Replicates (across all 13 populations)
...
directory <- "/Volumes/My Passport for Mac/01_PhD_PostDoc_Göttingen_Jena_Ilmenau/articles_ideas/github_rarefaction-like_analysis_genetic_diversity_Karbstein_et_al/GD_satur_Karbstein_et_al_und_rev/example/results/habitat_heterogeneity/"
...
for(i in sprintf("%02d", 1:5)) {
  mymergeddata_i <- multmerge(paste("/Volumes/My Passport for Mac/01_PhD_PostDoc_Göttingen_Jena_Ilmenau/articles_ideas/github_rarefaction-like_analysis_genetic_diversity_Karbstein_et_al/GD_satur_Karbstein_et_al_und_rev/example/results/habitat_heterogeneity/", i, sep = ""))
...
results = multmerge("/Volumes/My Passport for Mac/01_PhD_PostDoc_Göttingen_Jena_Ilmenau/articles_ideas/github_rarefaction-like_analysis_genetic_diversity_Karbstein_et_al/GD_satur_Karbstein_et_al_und_rev/example/results/habitat_heterogeneity/results/")
...
### HD ~ Number of Replicates (across all 13 populations)
